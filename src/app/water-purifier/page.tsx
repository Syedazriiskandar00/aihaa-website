      ...
      <section id="indoor" className="scroll-mt-24 bg-white py-16 lg:py-20">
        <div ref={indoorRef} className="scroll-reveal max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {/* CTA Card — fills grid */}
            <div className="scroll-reveal-child stagger-7 bg-[#FFFDE7] border-2 border-dashed border-[rgba(218,165,32,0.3)] rounded-2xl flex flex-col items-center justify-center p-8 text-center hover:border-solid hover:-translate-y-1 transition-all duration-300">

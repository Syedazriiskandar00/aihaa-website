        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-6">
              Hubungi Kami <span className="gold-gradient-text">Sekarang</span>
            </h2>
            <p className="text-muted-dark mb-8 max-w-md">
              Pakar penapis air kami sedia membantu anda memilih penapis air yang sesuai
              untuk rumah anda. Dapatkan cadangan peribadi dan tawaran istimewa.
            </p>

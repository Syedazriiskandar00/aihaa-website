        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="scroll-reveal-left">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 gold-gradient-bg text-white px-8 py-4 rounded-full font-semibold hover:opacity-90 transition-all hover:shadow-[0_0_20px_rgba(218,165,32,0.4)] motion-reduce:transition-none"
            >
          ...
          <div className="scroll-reveal-right relative" style={{ transitionDelay: "0.2s" }}>
